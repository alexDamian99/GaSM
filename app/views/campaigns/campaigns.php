...
<head>
    ...
    <title>GASM</title>
    <meta name="description" content="Campaigns list">
    ...
    <main>
        ...
        <div class="campaigns">
            <div class="campaigns__search">
                <form id="campaign-search" action="<?= getenv('path_to_public') ?>/campaigns/search"
                    class="campaigns__search__bar search-bar" method="GET">
                    <label>
                        <span><img src="<?php echo getenv("path_to_public"); ?>/assets/images/search.svg"
                                alt="search_icon"></span>
