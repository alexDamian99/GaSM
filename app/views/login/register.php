    ...
    <main>
        <form action="" method="POST">
            ...
            <div class="account-type">
                <input type="radio" id="radioPersonal" name="account" value="personal" onclick="myFunction()" checked>
                <label for="radioPersonal" class="radio">Personal</label>
                <input type="radio" id="radioCompany" name="account" value="company" onclick="myFunction()">
